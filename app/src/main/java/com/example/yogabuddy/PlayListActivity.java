...
public class PlayListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (title.equals("Stressed"))
        {
           arrayList.add(new SongsModel("TVARI - Tokyo Cafe","Reduce fear, anxiety and stress","2:33",R.drawable.tokyocafe));
           arrayList.add(new SongsModel("Happy Day","Reduce fear, anxiety and stress","1:48",R.drawable.happyday));
           arrayList.add(new SongsModel("One Last Time","Reduce fear, anxiety and stress","2:40",R.drawable.midnightrelaxation));
        ...
        if (title.equals("Focused & Mindfulness"))
        {
            arrayList.add(new SongsModel("TVARI - Tokyo Cafe","Reduce fear, anxiety and stress","2:33",R.drawable.tokyocafe));
            arrayList.add(new SongsModel("Happy Day","Reduce fear, anxiety and stress","1:48",R.drawable.happyday));
            arrayList.add(new SongsModel("One Last Time","Reduce fear, anxiety and stress","2:40",R.drawable.midnightrelaxation));
        ...
        if (title.equals("Midnight & relaxation"))
        {
            arrayList.add(new SongsModel("TVARI - Tokyo Cafe","Reduce fear, anxiety and stress","2:33",R.drawable.tokyocafe));
            arrayList.add(new SongsModel("Happy Day","Reduce fear, anxiety and stress","1:48",R.drawable.happyday));
            arrayList.add(new SongsModel("One Last Time","Reduce fear, anxiety and stress","2:40",R.drawable.midnightrelaxation));
        ...
        if (title.equals("Jogging & Cycling"))
        {
            arrayList.add(new SongsModel("TVARI - Tokyo Cafe","Reduce fear, anxiety and stress","2:33",R.drawable.tokyocafe));
            arrayList.add(new SongsModel("Happy Day","Reduce fear, anxiety and stress","1:48",R.drawable.happyday));
            arrayList.add(new SongsModel("One Last Time","Reduce fear, anxiety and stress","2:40",R.drawable.midnightrelaxation));
